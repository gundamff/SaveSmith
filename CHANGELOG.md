...
本文件记录面向用户的发布变化。格式参考 [Keep a Changelog](https://keepachangelog.com/zh-CN/1.1.0/)，版本号遵循 [SemVer](https://semver.org/lang/zh-CN/)。
...
[0.1.0]: https://github.com/gundamff/SaveSmith/releases/tag/v0.1.0
