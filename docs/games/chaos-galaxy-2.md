...
| 指挥官 | 经验、内政 / 军事 / 智力 / 血统、星级；**技能芯片**（名称下拉）；天赋 / 战略 / 战术只读。默认仅己方、可搜索；一键拉满己方。**不增删**；列表「阵营」由舰队挂载 / 势力领袖**推断**，本页不能直接改所属 |
| 舰队 | 卡片式编辑：势力 / 指挥官 / 旗舰 + 单位槽网格（等级 / 战力 / 能量）。默认仅己方。**一期不增删舰队/单位槽**。要把某人算作己方：在己方舰队上把他设为指挥官（或改该舰队所属势力） |
...
5. **指挥官没有独立「所属势力」字段。** 与《混沌兵团》驾驶员名单不同：CG2 不提供「收编/追加指挥官」。要让某人出现在「仅己方」过滤里，请到**舰队**页把该指挥官挂到己方舰队（并视需要从敌方舰队卸下），勿指望指挥官页改阵营列。
