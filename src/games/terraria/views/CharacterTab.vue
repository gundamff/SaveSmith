...
const difficulty = computed(() => {
  void editor.rev
  return editor.save.difficulty
})
const statLife = computed(() => {
  void editor.rev
  return editor.save.statLife
})
const statLifeMax = computed(() => {
  void editor.rev
  return editor.save.statLifeMax
})
const statMana = computed(() => {
  void editor.rev
  return editor.save.statMana
})
const statManaMax = computed(() => {
  void editor.rev
  return editor.save.statManaMax
})
const money = computed(() => {
  void editor.rev
  return moneyFromState(editor.save)
})
  ...
  <div :data-ss-rev="editor.rev">
    ...
    <el-form label-width="120px" style="max-width: 520px">
      <el-form-item :label="t('te.character.name')">
        <el-input :model-value="name" maxlength="20" @update:model-value="setName" />
      </el-form-item>
      <el-form-item :label="t('te.character.difficulty')">
        <el-select :model-value="difficulty" style="width: 100%" @update:model-value="setDiff">
